...
export const blogPosts: IBlogPost[] = [
  {
    ...
    href: "/test-1",
    imgUrl:
      "https://plus.unsplash.com/premium_photo-1694825173871-7b5df4d57ba5?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=988&q=80",
    tags: [
      {
        id: 1,
        name: "Design",
